...
function enviarDatosF4_3(){
	divResultado = document.getElementById('resultadoF4_3');

	tel1 = document.form4_3.tel1.value;
	dni = document.form4_3.dni.value;
	...
	else
	{
		  ...
		  ajax.onreadystatechange=function() {
		  	if (ajax.readyState==4) {
		  		oculto_div = document.getElementById('hidden_form4_3');
...
function LimpiarCamposF4(){
  document.form4_3.tel1.value="";
  document.form4_3.dni.value="";
}